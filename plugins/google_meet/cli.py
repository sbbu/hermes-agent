...
def register_cli(subparser: argparse.ArgumentParser) -> None:
    ...
    try:
        ...
        # flag it. The argparse dispatch will surface a clear error. Python
        # clears exception variables after the except block, so bind the text
        # into the fallback closure instead of closing over ``exc`` directly.
        error = str(exc)
