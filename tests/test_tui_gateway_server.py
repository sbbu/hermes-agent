...
def test_profile_scoped_agent_build_starts_mcp_discovery_in_profile_home(
    ...
    try:
        ...
        # _make_agent returning only means construction began successfully.
        # Wait for the build thread's final ready signal before restoring
        # monkeypatches or letting its session.info write leak into later tests.
