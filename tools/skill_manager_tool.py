...
SKILL_MANAGE_SCHEMA = {
    "name": "skill_manage",
    "description": (
        "Manage reusable procedural skills. Prefer patch for fixes and edit only for full "
        "rewrites; supporting files must live under references/templates/scripts/assets. "
        "Create after a difficult reusable workflow and repair stale skills immediately. "
        "Keep each description's first 57 characters self-contained. Confirm before create/delete. "
        "For delete, use absorbed_into=<existing umbrella> after merging, or empty string for pruning. "
        "Pinned skills may be patched but cannot be deleted."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "content": {
                "type": "string",
                "description": "Full SKILL.md for create/edit; read it before a complete edit."
            },
            "old_string": {
                "type": "string",
                "description": "Patch target text; include context for uniqueness unless replace_all."
            },
            "new_string": {
                "type": "string",
                "description": (
            ...
            "file_path": {
                "type": "string",
                "description": "Supporting path under references/templates/scripts/assets; patch defaults to SKILL.md."
            },
            "file_content": {
                "type": "string",
            ...
            "absorbed_into": {
                "type": "string",
                "description": "Delete only: existing umbrella after merge, or empty string for pure pruning."
            },
        },
